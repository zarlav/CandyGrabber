...
import { registerFriendRequestEvents } from "./friendRequestHandler.js";
import { registerGameRequestEvents } from "./gameRequestHandler.js";
import { renderFriendList } from "./friendListUI.js";
...
export class LobbyScene {
    constructor(app) {
        ...
        renderFriendList(this.friendListContainer, this.currentUserId, this.searchResultContainer, this.friendRequestManager, this.gameRequestManager);
    }

    async initSignalR() {
        await startConnection(authService.getCurrentUsername());

        registerChatEvents(this.container);
        registerFriendRequestEvents(this, this.friendRequestManager);
        registerGameRequestEvents(this, this.gameRequestManager);
    }
