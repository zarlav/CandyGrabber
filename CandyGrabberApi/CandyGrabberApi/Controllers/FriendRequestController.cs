...
namespace CandyGrabberApi.Controllers
{
    ...
    public class FriendRequestController : ControllerBase
    {
        ...
        public FriendRequestController(CandyGrabberContext db, IFriendRequestService friendRequestService, IFriendsListService friendsListService, IUserService userService)
        {
            _db = db;
